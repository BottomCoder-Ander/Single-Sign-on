...
public class RedisCache {
    ...
    public <T> BoundSetOperations<String, T>  setCacheSet(final String key, T data, long time, TimeUnit unit){
    ...
    public <T> boolean isCacheSetMember(final String key1 , final T data) {
        return redisTemplate.boundSetOps(key1).isMember(data);
    }
